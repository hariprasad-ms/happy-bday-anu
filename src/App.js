...
export const App = () => (
  <Canvas flat camera={{ fov: 75, position: [0, 0, 20] }} eventSource={document.getElementById('root')} eventPrefix="client">
    ...
    <Frame id="01" name={``} author="FamiliA" bg="#e4cdac" position={[-1.15, 0, 0]} rotation={[0, 0.5, 0]}>
      <Gltf src="pickles_3d_version_of_hyuna_lees_illustration-transformed.glb" scale={8} position={[0, -0.7, -2]} />
    </Frame>
    <Frame id="02" name="11:11" author={`Heiii Bday Girl...\nMany many Happy \nReturns of the Day...`}>
      <Gltf src="fiesta_tea-transformed.glb" position={[0, -2, -3]} />
    </Frame>
    <Frame id="03" name="" author="Can you Figure this out?" bg="#d1d1ca" position={[1.15, 0, 0]} rotation={[0, -0.5, 0]}>
